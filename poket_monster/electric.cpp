...
CElectric::CElectric(std::string p_name, int p_hp, int p_hpMax, int p_speed, int p_attack, int p_defense) : CMonster(p_name, p_hp, p_hpMax, p_speed, p_attack, p_defense, Monster::TYPE::electric){
}
